...
var _warnValidStyle = function warnValidStyle() {};
{
  ...
  _warnValidStyle = function (name, value) {
    if (name.indexOf('-') > -1) {
...
var warnValidStyle$1 = _warnValidStyle;
...
var _validateProperty$ = function validateProperty$1() {};
{
  ...
  _validateProperty$ = function (tagName, name, value, eventRegistry) {
...
var warnUnknownProperties = function warnUnknownProperties(type, props, eventRegistry) {
  {
    var unknownProps = [];
    for (var key in props) {
      var isValid = _validateProperty$(type, key, props[key], eventRegistry);
      if (!isValid) {
...
var _batchedUpdatesImpl2 = function batchedUpdatesImpl(fn, bookkeeping) {
  return fn(bookkeeping);
};
var _flushSyncImpl2 = function flushSyncImpl() {};
...
function batchedUpdates(fn, a, b) {
  ...
  try {
    return _batchedUpdatesImpl2(fn, a, b);
  } finally {
...
function setBatchingImplementation(_batchedUpdatesImpl, _discreteUpdatesImpl, _flushSyncImpl) {
  _batchedUpdatesImpl2 = _batchedUpdatesImpl;
  _flushSyncImpl2 = _flushSyncImpl;
}
...
var ImmediatePriority = ImmediatePriority$1;
var UserBlockingPriority = UserBlockingPriority$1;
var NormalPriority = NormalPriority$1;
var LowPriority = LowPriority$1;
var IdlePriority = IdlePriority$1;
var rendererID = null;
...
function scheduleCallbackIfUnblocked(queuedEvent, unblocked) {
  if (queuedEvent.blockedOn === unblocked) {
    ...
    if (!hasScheduledReplayAttempt) {
      ...
      unstable_scheduleCallback(NormalPriority$1, replayUnblockedEvents);
    }
  }
}
...
var _validateDOMNesting = function validateDOMNesting() {};
var _updatedAncestorInfo = function updatedAncestorInfo() {};
{
  ...
  _updatedAncestorInfo = function (oldInfo, tag) {
  ...
  var didWarn$1 = {};
  _validateDOMNesting = function (childTag, childText, ancestorInfo) {
...
function getRootHostContext(rootContainerInstance) {
  ...
  }
  {
    ...
    var ancestorInfo = _updatedAncestorInfo(null, validatedTag);
    return {
      namespace: namespace,
...
function getChildHostContext(parentHostContext, type, rootContainerInstance) {
  {
    ...
    var ancestorInfo = _updatedAncestorInfo(parentHostContextDev.ancestorInfo, type);
    return {
      namespace: namespace,
      ancestorInfo: ancestorInfo
    };
...
function createInstance(type, props, rootContainerInstance, hostContext, internalInstanceHandle) {
  var parentNamespace;
  {
    ...
    _validateDOMNesting(type, null, hostContextDev.ancestorInfo);
    if (typeof props.children === 'string' || typeof props.children === 'number') {
      var string = '' + props.children;
      var ownAncestorInfo = _updatedAncestorInfo(hostContextDev.ancestorInfo, type);
      _validateDOMNesting(null, string, ownAncestorInfo);
    }
...
function createTextInstance(text, rootContainerInstance, hostContext, internalInstanceHandle) {
  {
    var hostContextDev = hostContext;
    _validateDOMNesting(null, text, hostContextDev.ancestorInfo);
  }
...
var _warnForMissingKey = function warnForMissingKey(child, returnFiber) {};
{
  ...
  _warnForMissingKey = function (child, returnFiber) {
  ...
  function warnOnInvalidKey(child, knownKeys, returnFiber) {
    {
      ...
      switch (child.$$typeof) {
        case REACT_ELEMENT_TYPE:
        case REACT_PORTAL_TYPE:
          _warnForMissingKey(child, returnFiber);
          var key = child.key;
...
var _shouldErrorImpl = function shouldErrorImpl(fiber) {
  return null;
};
function shouldError(fiber) {
  return _shouldErrorImpl(fiber);
}
var _shouldSuspendImpl = function shouldSuspendImpl(fiber) {
  return false;
};
function shouldSuspend(fiber) {
  return _shouldSuspendImpl(fiber);
}
...
var setSuspenseHandler = null;
{
  ...
  setErrorHandler = function (newShouldErrorImpl) {
    _shouldErrorImpl = newShouldErrorImpl;
  };
  setSuspenseHandler = function (newShouldSuspendImpl) {
    _shouldSuspendImpl = newShouldSuspendImpl;
  };
}
...
export { Internals as __USE_PROPER_TECHNOLOGY_AND_YOU_WILL_BE_RECRUITED, createPortal$1 as createPortal, createRoot$1 as createRoot, reactDom as default, findDOMNode, flushSync$1 as flushSync, hydrate, hydrateRoot$1 as hydrateRoot, render, unmountComponentAtNode, batchedUpdates$1 as unstable_batchedUpdates, renderSubtreeIntoContainer as unstable_renderSubtreeIntoContainer, ReactVersion as version };
